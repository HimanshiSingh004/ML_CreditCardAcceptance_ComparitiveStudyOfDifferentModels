...
#Dividing into training and test data. We are taking 25% random data as test data
...
#Here onwards we'll be applying different machine learning models and will compare there results at the end of it.
...
#Comparing scores generated by all three models
